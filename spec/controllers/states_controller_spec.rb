  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved state as @state" do
        ...
        post :create, {:state => { "state" => "invalid value" }}, valid_session
        assigns(:state).should be_a_new(State)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested state" do
        ...
        State.any_instance.should_receive(:update).with({ "state" => "MyString" })
        put :update, {:id => state.to_param, :state => { "state" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the state as @state" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        State.any_instance.stub(:save).and_return(false)
        put :update, {:id => state.to_param, :state => { "state" => "invalid value" }}, valid_session
        assigns(:state).should eq(state)
      end
