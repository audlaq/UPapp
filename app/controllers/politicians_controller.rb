class PoliticiansController < ApplicationController
  ...
  private
    ...
    def politician_params
      params.require(:politician).permit(:name, :image, :position1, :position2, :state, :district, :party, :sworn_in, :person_defeated, :votes_w_party, :votes_vs_party, :abstains)
    end
end
